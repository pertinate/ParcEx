...
{
    public static MobileCamera instance;
    ...
    public void Resume(Transform target = null)
    {
        ...
        if (target != null)
            ...
            this.target = Drone.instance.transform.parent;
    }
    ...
    private void Do()
    {
        ...
        if (Physics.Raycast(target.TransformPoint(bumperRayOffset), back, out hit, bumperDistanceCheck)
            && hit.transform != target && hit.transform.tag != "Non Bump") // ignore ray-casts that hit the user. DR
        {
